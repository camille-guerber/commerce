 ...
 */
final class Version20190322103631 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE marque_modele (marque_id INT NOT NULL, modele_id INT NOT NULL, INDEX IDX_1CFB4CB14827B9B2 (marque_id), INDEX IDX_1CFB4CB1AC14B70A (modele_id), PRIMARY KEY(marque_id, modele_id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB COMMENT = \'\' ');
